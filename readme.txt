...
Version | Date | Notes
[ 09-04-19 ] | [ 4 SEP 2019 ] | [
-Improved tracking markers for vehicles
-Adjusted max number of enemy units
-Move Unit will now detach carried when carrier is unconscious
-Fixed no escort shown in list of helicopter transport
-Improved cargo and ammo drop landing
]

[ 08-23-19 ] | [ 23 AUG 2019 ] | [
-Improved Cargo Slingload. You can now select type of helicopter and weight is displayed for lift objects as well as max lift weight of helicopters
-Added tracking marker to air support aircraft
-Helicopter transport can now select transport type and escort type
-Helicopter Transport can now move to water locations like freedom and Liberty and land more reliably
-Player Vehicles now spawn with camo nets
-Objective Artillery and Anti-air may spawn with camo nets
-Fixed optional Player IFF param
-Vehicle Lists should now show Different vehicle camo types ie Olive and Sand
-Fixed maxPlayers to reflect actual playable slots
]
...
-Helicopter cargo airlift can now be used to transport a sling load to a specified destination
]

[ 16-03-19 ] | [ 16 MAR 2019 ] | [
...
[ 1-1-0 ] | [ 10 FEB 2018 ] | [
-Added eventhandler to delete players body on disconnect so AI wont be left everywhere
-fixed issue where high altitude locations would not spawn tasks properly
-Transport should now set brakes
-Can recruit basic AI units to your squad
-Can remove selected AI units from your squad
-Adjusted PUAV to spawn higher to avoid collisions with rocks
-Added more filters to the vehicle spawn lists
-Adjusted Gunship altitude and distance and actions
-Organized com menu options
-Added new anti air defenses
-Added full heal action to medical hemtt
-Moved main base to carrier and destroyer on island maps
-Vehicle rearm is now an action near the huron containers
]
...
-Unitlist is now mostly automatically captured from the config
-Added civilian helicopters to random helipads
-various adjustments/tweaks
...
1. Move the folder [ enemy_assault.Island.pbo ] into the following (default) directory:
...
Firewill FA16C, RHS Escalation, ACE
