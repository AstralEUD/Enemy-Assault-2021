...
for "_i" from 0 to (count _cfgvehicles)-1 do {
	...
	if (isClass _vehicle) then {
		...
		if (((_wCName iskindof "B_Soldier_F") or (_wCName iskindof "B_Pilot_F") or (_wCName iskindof "B_helicrew_F") or (_wCName iskindof "B_crew_F")) && (_wside == 1) && (_wscope == 2) && ((_wfaction == "rhs_faction_usarmy_wd") or (_wfaction == "rhs_faction_usarmy_d") or (_wfaction == "rhs_faction_usmc_wd") or (_wfaction == "rhs_faction_usmc_d") or (_wfaction == "rhs_faction_socom"))) then {
