...
class RscButtonMenuSS: RscShortcutButtonSS
{
	idc = -1;
	type = CT_SHORTCUTBUTTON;
...
class RscButtonMenuOKSS: RscButtonMenuSS
{
	idc = 1;
	shortcuts[] =
	{
...
class SakyEarplugSettingGUI{
	...
	class RscSlider_1900: RscXSliderHSS
	{
		idc = 1900;
	...
	class RscButton_1600: RscButtonMenuOKSS
	{
		idc = 2;
		style = ST_CENTER;
