...
player createDiaryRecord ["MissionFeatures", ["서버 제재 규칙", "
- 인질 사살 3회 이상시 12시간 밴, 5회 이상시 24시간 밴, 8회 이상시 72시간 밴, 10회 이상시 7일 밴, 15회 이상시 영구밴 <br/>
인질 사살 횟수는 분기 (1/2/3/4) 별로 초기화
"]];