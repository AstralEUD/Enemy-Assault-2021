...
[AmmoBox01,true,true,false] call BIS_fnc_addVirtualBackpackCargo;
...
["AmmoBoxInit", AmmoBox02, false, {true}] call BIS_fnc_arsenal;

[AmmoBox02,true,true,false] call BIS_fnc_addVirtualBackpackCargo;
[AmmoBox02,true,true,false] call BIS_fnc_addVirtualItemCargo;
[AmmoBox02,true,true,false] call BIS_fnc_addVirtualMagazineCargo;
[AmmoBox02,true,true,false] call BIS_fnc_addVirtualWeaponCargo;
