...
if (_PARAM_TASKTYPES == 1) then {
	...
	_objlist = ["leader","rescue","dataterminal","intel","ZSU_AA2","leader2","dataterminal2","intel2","rescue2","ZSU_AA","intel3","leader3","Bombtruck","dataterminal3","leader4"];//"leader","rescue","ARTY","ammo","intel","ZSU_AA2","leader2","Acquireobj","intel2","rescue2","ZSU_AA","ammo2","intel3","leader3","ammo3","Bombtruck","leader4","ARTY2"
};
