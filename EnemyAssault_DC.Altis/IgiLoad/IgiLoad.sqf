...
if (isnil "IL_Variables") then
{
	...
	// Supported vehicles
	IL_Supported_Vehicles_OFFROAD = ["C_Offroad_01_F", "B_G_Offroad_01_F", "B_mas_mar_Offroad_01_F", "rhsusf_m998_w_s_2dr_halftop", "rhsusf_m998_w_s_2dr", "rhsusf_m998_d_s_2dr_halftop", "rhsusf_m998_d_s_2dr", "rhsusf_m998_d_2dr", "rhsusf_m998_d_2dr_halftop", "rhsusf_m998_w_2dr"];
	IL_Supported_Vehicles_VAN = ["C_Van_01_box_F", "B_G_Van_01_transport_F", "C_Van_01_transport_F"];
	IL_Supported_Vehicles_HEMTT = ["B_Truck_01_covered_F", "B_Truck_01_transport_F", "B_Truck_01_box_F", "rhsusf_M977A4_BKIT_M2_usarmy_d", "rhsusf_M977A4_BKIT_M2_usarmy_wd", "rhsusf_M977A4_BKIT_usarmy_d", "rhsusf_M977A4_usarmy_wd"];
	IL_Supported_Vehicles_KAMAZ = ["I_Truck_02_transport_F", "O_Truck_02_transport_F", "I_Truck_02_covered_F", "O_Truck_02_covered_F", "rhsusf_M1078A1P2_wd_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_B_wd_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_B_M2_wd_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_wd_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_B_wd_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_B_M2_wd_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_d_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_B_d_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_B_M2_d_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_d_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_B_d_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_B_M2_d_flatbed_fmtv_usarmy"];
	IL_Supported_Vehicles_TEMPEST = ["O_Truck_03_transport_F", "O_Truck_03_covered_F", "RHS_Ural_Open_Civ_01", "RHS_Ural_Open_Civ_02", "RHS_Ural_Open_Civ_03", "RHS_Civ_Truck_02_transport_F"];
	IL_Supported_Vehicles_MOHAWK = ["I_Heli_Transport_02_F", "CH49_Mohawk_FG", "Marinir_CH49_Mohawk_FG"];
	IL_Supported_Vehicles_CHINOOK = ["CH_147F", "CH_47F", "RHS_CH_47F_light", "RHS_CH_47F", "RHS_Mi8mt_Cargo_vv"];
	IL_Supported_Vehicles_MH9 = ["B_Heli_Light_01_F", "B_mas_mar_Heli_Light_01_F"];
	IL_Supported_Vehicles_C130J = ["sab_C130_J", "sab_C130_JC", "sab_C130_JE", "sab_C130_JEC", "sab_C130_JT", "sab_C130_H", "sab_C130_HE", "sab_C130_HEC", "sab_C130_HC", "sab_C130_FA", "sab_C130_LC", "sab_C130_LC_Ski", "sab_C130_CG", "sab_C130_FP", "sab_C130_CSP", "sab_C130_J_FF", "sab_C130_J_FF2", "sab_L100_AL", "sab_C130_H_CSAT", "sab_C130_H_CSAT2", "sab_C130_H_CSAT3", "sab_C130_H_AAF", "sab_C130_H_AAF2", "sab_C130_H_AAF3"];
	...
	IL_Supported_Vehicles_USAF_CV22 = ["USAF_CV22"];
	
	
	IL_Supported_Vehicles_All = IL_Supported_Vehicles_USAF_CV22 + IL_Supported_Vehicles_C130J + IL_Supported_Vehicles_C17 + IL_Supported_Vehicles_MH9 + IL_Supported_Vehicles_MOHAWK + IL_Supported_Vehicles_KAMAZ + IL_Supported_Vehicles_TEMPEST + IL_Supported_Vehicles_HEMTT + IL_Supported_Vehicles_VAN + IL_Supported_Vehicles_OFFROAD + IL_Supported_Vehicles_CHINOOK;

	// Vehicles with the ability to dropping the load on the parachute
	IL_Para_Drop_Vehicles = IL_Supported_Vehicles_USAF_CV22 + IL_Supported_Vehicles_MH9 + IL_Supported_Vehicles_MOHAWK + IL_Supported_Vehicles_C130J + IL_Supported_Vehicles_C17 + IL_Supported_Vehicles_CHINOOK;

	//Supported cargo
	IL_Supported_HEMTT = ["B_Truck_01_covered_F", "B_Truck_01_transport_F", "B_Truck_01_box_F", "rhsusf_M977A4_BKIT_M2_usarmy_d", "rhsusf_M977A4_BKIT_M2_usarmy_wd", "rhsusf_M977A4_BKIT_usarmy_d", "rhsusf_M977A4_usarmy_wd"];
	IL_Supported_KAMAZ = ["I_Truck_02_transport_F", "O_Truck_02_transport_F", "I_Truck_02_covered_F", "O_Truck_02_covered_F", "rhsusf_M1078A1P2_wd_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_B_wd_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_B_M2_wd_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_wd_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_B_wd_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_B_M2_wd_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_d_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_B_d_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_B_M2_d_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_d_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_B_d_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_B_M2_d_flatbed_fmtv_usarmy"];
	IL_Supported_TEMPEST = ["O_Truck_03_transport_F", "O_Truck_03_covered_F", "RHS_Ural_Open_Civ_01", "RHS_Ural_Open_Civ_02", "RHS_Ural_Open_Civ_03", "RHS_Civ_Truck_02_transport_F"];
	...
	IL_Supported_OFFROAD = ["C_Offroad_01_F", "B_G_Offroad_01_F", "B_G_Offroad_01_armed_F", "rhsusf_m998_w_s_2dr_halftop", "rhsusf_m998_w_s_2dr", "rhsusf_m998_d_s_2dr_halftop", "rhsusf_m998_d_s_2dr", "rhsusf_m998_d_2dr", "rhsusf_m998_d_2dr_halftop", "rhsusf_m998_w_2dr"];
	IL_Supported_SUV = ["C_SUV_01_F"];
	IL_Supported_Hatchback = ["C_Hatchback_01_F", "C_Hatchback_01_sport_F"];
	IL_Supported_Hummvee = ["rhsusf_rg33_usmc_d", "rhsusf_rg33_m2_usmc_d", "rhsusf_rg33_usmc_wd", "rhsusf_rg33_m2_usmc_wd", "rhsusf_m998_w_2dr", "rhsusf_m998_d_2dr", "rhsusf_m998_w_s_2dr", "rhsusf_m998_d_s_2dr", "rhsusf_m998_w_2dr_halftop", "rhsusf_m998_d_2dr_halftop", "rhsusf_m998_w_s_2dr_halftop", "rhsusf_m998_d_s_2dr_halftop", "rhsusf_m998_w_2dr_fulltop", "rhsusf_m998_d_2dr_fulltop", "rhsusf_m998_w_s_2dr_fulltop", "rhsusf_m998_d_s_2dr_fulltop", "rhsusf_m998_w_4dr", "rhsusf_m998_d_4dr", "rhsusf_m998_w_s_4dr", "rhsusf_m998_d_s_4dr", "rhsusf_m998_w_4dr_halftop", "rhsusf_m998_d_4dr_halftop", "rhsusf_m998_w_s_4dr_halftop", "rhsusf_m998_d_s_4dr_halftop", "rhsusf_m998_w_4dr_fulltop", "rhsusf_m998_d_4dr_fulltop", "rhsusf_m998_w_s_4dr_fulltop", "rhsusf_m998_d_s_4dr_fulltop", "rhsusf_m1025_w", "rhsusf_m1025_d", "rhsusf_m1025_w_s", "rhsusf_m1025_d_s", "rhsusf_m1025_w_m2", "rhsusf_m1025_d_m2", "rhsusf_m1025_w_s_m2", "rhsusf_m1025_d_s_m2", "rhsusf_m1025_w_mk19", "rhsusf_m1025_d_Mk19", "rhsusf_m1025_w_s_Mk19", "rhsusf_m1025_d_s_Mk19", "rhsusf_m109_usarmy", "rhsusf_m109d_usarmy", "rhsusf_m113_usarmy", "rhsusf_m113d_usarmy"];
	...
	IL_Supported_Supply_Crate = ["I_CargoNet_01_ammo_F", "O_CargoNet_01_ammo_F", "B_CargoNet_01_ammo_F", "B_supplyCrate_F", "IG_supplyCrate_F", "O_supplyCrate_F", "I_supplyCrate_F", "C_supplyCrate_F"];
	...
	IL_Supported_Rubberboat = ["I_Boat_Transport_01_F", "O_Boat_Transport_01_F", "B_G_Boat_Transport_01_F", "B_Boat_Transport_01_F", "C_Rubberboat", "O_Lifeboat", "B_Lifeboat", "Marinir_duck_base_F", "B_mas_mar_Boat_Transport_01_F","USAF_MOABdisplay"];
	...
	IL_Supported_Cargo10 = ["Land_Cargo10_blue_F", "Land_Cargo10_brick_red_F", "Land_Cargo10_cyan_F", "Land_Cargo10_grey_F", "Land_Cargo10_light_blue_F", "Land_Cargo10_light_green_F", "Land_Cargo10_military_green_F", "Land_Cargo10_orange_F", "Land_Cargo10_red_F", "Land_Cargo10_sand_F", "Land_Cargo10_white_F", "Land_Cargo10_yellow_F"];
	IL_Supported_Dixon = ["B_APC_Wheeled_01_cannon_F", "I_APC_Wheeled_03_cannon_F", "O_APC_Wheeled_02_rcws_F"];
	IL_Supported_Dixon1 = ["B_MBT_01_TUSK_F", "B_APC_Tracked_01_CRV_F", "I_APC_tracked_03_cannon_F",  "O_APC_Tracked_02_cannon_F", "O_MBT_02_cannon_F", "I_MBT_03_cannon_F", "B_MBT_01_cannon_F", "B_MBT_01_arty_F", "rhsusf_m1a1fep_d"];
	...
	IL_Supported_Cargo_NonVeh_Kamaz = IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank + IL_Supported_Box_H1 + IL_Supported_Box_H2 + IL_Supported_Cargo20 + IL_Supported_Cargo10;
	...
	IL_Supported_Cargo_Veh_USAF_CV22 = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV;
	IL_Supported_Cargo_NonVeh_USAF_CV22 = IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank;
	IL_Supported_Cargo_USAF_CV22 = IL_Supported_Cargo_Veh_USAF_CV22 + IL_Supported_Cargo_NonVeh_USAF_CV22;
};
//	END VARIABLES
...
if (isnil "IL_Procedures") then
{
	...
	IL_Init_Veh =
	{
		...
		if (_obj_type in IL_Supported_Vehicles_C130J) then
		{
			...
			if (_obj_type in  ["sab_C130_JC", "sab_C130_JEC", "sab_C130_JT", "sab_C130_HEC", "sab_C130_HC", "sab_L100_AL", "sab_C130_H_CSAT2", "sab_C130_H_CSAT3", "sab_C130_H_AAF2", "sab_C130_H_AAF3"]) then
			{
				if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", IL_Num_Slots_C130J, true];};
				if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", 5.5, true];};
			}
			else
			{
				if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", (IL_Num_Slots_C130J / 2) - 1, true];};
				if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", 12.5, true];};
			};
		...
		if (_obj_type in IL_Supported_Vehicles_USAF_CV22) then
		{
			if ((isNil {_obj getVariable "box_num"}) || (_force)) then {_obj setVariable["box_num", 0, true];};
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
			if ((isNil {_obj getVariable "can_copilot"}) || (_force)) then {_obj setVariable["can_copilot", IL_Can_CoPilot, true];};
		...
		if (_obj_type in IL_Supported_Vehicles_CHINOOK) then
		{
			...
			if (_obj_type in ["RHS_CH_47F_light", "RHS_CH_47F", "RHS_Mi8mt_Cargo_vv"]) then
			{
				if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", IL_Num_Slots_CHINOOK, true];};
		...
		if (_obj_type in IL_Supported_Vehicles_KAMAZ) then
		{
			...
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if (_obj_type in ["rhsusf_M1078A1P2_wd_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_B_wd_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_B_M2_wd_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_wd_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_B_wd_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_B_M2_wd_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_d_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_B_d_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_B_M2_d_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_d_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_B_d_flatbed_fmtv_usarmy", "rhsusf_M1083A1P2_B_M2_d_flatbed_fmtv_usarmy"]) then
			{
				if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", .05, true];};
		...
		if (_obj_type in IL_Supported_Vehicles_TEMPEST) then
		{
			...
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if (_obj_type in ["RHS_Ural_Open_Civ_01", "RHS_Ural_Open_Civ_02", "RHS_Ural_Open_Civ_03", "RHS_Civ_Truck_02_transport_F"]) then
			{
				if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -0.04, true];};
		...
		if (_obj_type in IL_Supported_Vehicles_HEMTT) then
		{
			...
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if (_obj_type in ["rhsusf_M977A4_BKIT_M2_usarmy_d", "rhsusf_M977A4_BKIT_M2_usarmy_wd"]) then
			{
				if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", 0.89784, true];};
				if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", -0.5, true];};
			}
			else
			{
...
//	END IL_Init_Veh
	...
	IL_Init_Box =
	{
		...
		if (_obj_type in IL_Supported_Cargo10) then
		{
			...
			_obj setVariable["cargo_offset", 1.1, true];//HEMETT Box ~2.09281
			//LOCAL
			//_obj setMass 2400;
			[_obj, 2400] call IL_SetNewMass;
		};
		...
		{
			if (_obj_type in ["rhsusf_rg33_usmc_d", "rhsusf_rg33_m2_usmc_d"]) then
			{
			...
			{
				_obj setVariable["slots", 7, true];
				if (_obj_type in ["rhsusf_rg33_usmc_wd", "rhsusf_rg33_m2_usmc_wd"]) then
				{
					_obj setVariable["zload_cargo", 2.25, true];
					_obj setVariable["slots", 7, true];
					_obj setVariable["cargo_offset", 3.2, true];
				...
				else
				{
					...
					if (_obj_type in ["rhsusf_m1025_d_s_m2", "rhsusf_m1025_d_s_Mk19"]) then
					{
						_obj setVariable["zload_cargo", 2.10, true];
						_obj setVariable["slots", 5, true];
...
//	END IL_Cargo_Para
	...
	IL_Do_Load =
	{
		...
		if ((_obj_type in IL_Supported_Cargo_USAF_CV22) && (_doors == "B")) then
		{
			if (IL_DevMod) then
			{
				Player globalChat Format ["IgiLoad ""%1"". Do_load vehicle type: ""%2"" and doors: ""%3""", IL_Script_Inst, _obj_type, _doors];
			...
			_sdist = IL_SDistL + IL_SDistL_Heli_offset;
			_spoint = _v modelToWorld [0,-9,-4.3];
			_box_num = _v getVariable "box_num";
			_slot_num = _v getVariable "slots_num";
		};
		...
		{
			{
				...
				if ((typeOf _x) in (IL_Supported_Cargo20 + IL_Supported_Cargo10 + ["Land_WaterTank_F"])) then
				{
					_turn = true;
				};
				...
				else
				{
					...
					if ((_box_num > _slot_num) && !_done) then
					{
						...
						if ((_obj_type in IL_Supported_Vehicles_USAF_CV22)  && (_doors == "B")) then
						{
...
//	END IL_Do_Unload
	...
	IL_GetOut =
	{
		...
		if ((typeOf _v) in IL_Supported_Vehicles_USAF_CV22) then
		{
			_dist_out = 5;
			_dist_out_para = 11;
		};
...
if (_obj_main_type in IL_Supported_Vehicles_USAF_CV22) then
{
	if (IL_DevMod) then
	{
		Player globalChat Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_USAF_CV22.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;
	
	if (_obj_main_type == "USAF_CV22") then
	{
		_obj_main addAction [
...
//		"('Cargo' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (((getPosATL _target) select 2) >= IL_Para_Jump_ATL) && (_target animationPhase 'ramp_bottom' < 0.1) && (_target getVariable 'usable_ramp')"
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on CV22</t>",
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_USAF_CV22] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-9,-3], IL_Supported_Cargo_NonVeh_USAF_CV22, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-9,-5.4], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt) && (_target animationPhase 'ramp_bottom' == 1) && (_target animationPhase 'ramp_top' == 1)"
	];

	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on CV22</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_USAF_CV22] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-9,-3], IL_Supported_Cargo_Veh_USAF_CV22, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-9,-5.4], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt) && (_target animationPhase 'ramp_bottom' == 1) && (_target animationPhase 'ramp_top' == 1)"
	];

	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from CV22</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	...
	// _obj_main addAction [
	// "<t color=""#0000ff"">Open lower part of ramp in CV22</t>",
	// {
	...
	// _obj_main addAction [
	// "<t color=""#0000ff"">Close lower part of ramp in CV22</t>",
	// {
