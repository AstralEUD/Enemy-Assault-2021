/*
V1.6 script by: Ghost - Creates specified aircraft and flys to point on map specified by left click and drops ammo box.
ghst_ammodrop = [player,300,"airtype","cratetype",ghst_fnc_arsenal,300,30] spawn ghst_fnc_ammodrop;
*/
...
_crateammo = _this select 4;//ghst_fnc_arsenal
_flyheight = _this select 5;
_delay = (_this select 6) * 60;// time before ammo support can be called again
...
_air sidechat "I am inbound with your Ammo";
